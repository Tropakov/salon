    ...
    public partial class klienti : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("insert into klient(id_klient, fio, telefon, adres) value('" + textBox1.Text + "','" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "');", conn);
                conn.Open();
                cmd.ExecuteReader();
                conn.Close();
                getinfo();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlConnection conn = new MySqlConnection("Server=localhost;Database=salon;User=root;Password=2633;");
                MySqlCommand cmd = new MySqlCommand("update klient set id_klient ='" + textBox1.Text + "', fio = '" + textBox2.Text + "', telefon = '" + textBox3.Text + "', adres = '" + textBox4.Text + "' where id_men =" + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";", conn);
                Console.WriteLine("update klient set id_klient ='" + textBox1.Text + "', fio = '" + textBox2.Text + "', telefon = '" + textBox3.Text + "', adres = '" + textBox4.Text + "' where id_men =" + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";");
                conn.Open();
                cmd.ExecuteReader();
                conn.Close();
                getinfo();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                {
                    string del = "delete from klient where id_klient = " + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";";
                    do_Action(del);
                    getinfo();
                }
            }
