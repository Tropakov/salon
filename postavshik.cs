    ...
    public partial class postavshik : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("insert into postavshik(id_post, adres, telefon) value('" + textBox1.Text + "','" + textBox2.Text + "', '" + textBox3.Text + "');", conn);
                conn.Open();
                cmd.ExecuteReader();
                conn.Close();
                getinfo();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlConnection conn = new MySqlConnection("Server=localhost;Database=salon;User=root;Password=2633;");
                MySqlCommand cmd = new MySqlCommand("update postavshik set id_post ='" + textBox1.Text + "', adres = '" + textBox2.Text + "', telefon = '" + textBox3.Text + "' where id_post =" + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";", conn);
                Console.WriteLine("update postavshik set id_post ='" + textBox1.Text + "', adres = '" + textBox2.Text + "', telefon = '" + textBox3.Text + "' where id_post =" + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";");
                conn.Open();
                cmd.ExecuteReader();
                conn.Close();
                getinfo();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                {
                    string del = "delete from postavshik where id_post = " + dataGridView1[0, dataGridView1.CurrentRow.Index].Value.ToString() + ";";
                    do_Action(del);
                    getinfo();
                }
            }
